...
#ifndef LRPC_INTERNAL_COMPILER_GENERATOR_HELPERS_H
#define LRPC_INTERNAL_COMPILER_GENERATOR_HELPERS_H
...
inline std::string GetPrefixedComments(const DescriptorType* desc, bool leading,
  ...
  std::vector<std::string> out;
  if (leading) {
    lrpc_generator::GetComment(
        desc, lrpc_generator::COMMENTTYPE_LEADING_DETACHED, &out);
    std::vector<std::string> leading;
    lrpc_generator::GetComment(desc, lrpc_generator::COMMENTTYPE_LEADING,
                               &leading);
    out.insert(out.end(), leading.begin(), leading.end());
  } else {
    lrpc_generator::GetComment(desc, lrpc_generator::COMMENTTYPE_TRAILING,
                               &out);
  }
...
#endif  // LRPC_INTERNAL_COMPILER_GENERATOR_HELPERS_H
